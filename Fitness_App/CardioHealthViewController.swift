//
//  CardioHealthViewController.swift
//  Fitness_App
//
...
class CardioHealthViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        titleLabel.text = "CardioHealth Loss Plan"
        ...
        for (index, item) in planItems.enumerated() {
            let videoView = CardioHealthVideoView(title: item.title, description: item.description, videoURL: item.videoURL)
...
class CardioHealthVideoView: UIView {
