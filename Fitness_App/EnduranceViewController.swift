...
class EnduranceViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        titleLabel.text = "Endurance Plan"
        ...
        for (index, item) in planItems.enumerated() {
            let videoView = EnduranceVideoView(title: item.title, description: item.description, videoURL: item.videoURL)
...
class EnduranceVideoView: UIView {
