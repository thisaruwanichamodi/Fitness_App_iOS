...
class FlexibilityViewController: UIViewController {
    ...
    private func setupUI() {
        ...
        titleLabel.text = "Flexibility Loss Plan"
        ...
        for (index, item) in planItems.enumerated() {
            let videoView = FlexibilityVideoView(title: item.title, description: item.description, videoURL: item.videoURL)
...
class FlexibilityVideoView: UIView {
